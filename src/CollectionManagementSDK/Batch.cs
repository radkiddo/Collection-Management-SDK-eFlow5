...
namespace eFlow.CollectionManagement
{
    ...
    public class Batch : BatchInternals, IDisposable
    {
        ...
        #region "Batch.UnlockSpecificCollection()"
        /// <summary>
        /// [Static] Batch.UnlockSpecificCollection() --> Unlocks a specific collection given the collection's name.
        /// </summary>
        ...
        /// <returns>Returns 1 of successful, otherwise 0 or -1.</returns>
        /// <example><code>Batch.UnlockSpecificCollection("000002349_0001", "Data Source=RADKIDDO-PC\EFLOW;Initial Catalog=SwitchDemo_Workflow;Integrated Security=True");</code></example>
        public static int UnlockSpecificCollection(string CollectionName, string connectionString)
        {
            return InternalUnlockSpecificCollection(CollectionName, connectionString);
        }
        #endregion "Batch.UnlockSpecificCollection()"
